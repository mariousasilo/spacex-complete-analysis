...
def get_scatter_chart(entered_site, slider_range):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.scatter(filtered_df[mask & (filtered_df['Launch Site'] == 'CCAFS LC-40')],
                         x='Payload Mass (kg)', y='class', color="Booster Version Category")
        return fig
    elif entered_site == 'VAFB SLC-4E':
        fig = px.scatter(filtered_df[mask & (filtered_df['Launch Site'] == 'VAFB SLC-4E')],
                         x='Payload Mass (kg)', y='class', color="Booster Version Category")
        return fig
    elif entered_site == 'KSC LC-39A':
        fig = px.scatter(filtered_df[mask & (filtered_df['Launch Site'] == 'KSC LC-39A')],
                         x='Payload Mass (kg)', y='class', color="Booster Version Category")
        return fig
    elif entered_site == 'CCAFS SLC-40':
        fig = px.scatter(filtered_df[mask & (filtered_df['Launch Site'] == 'CCAFS SLC-40')],
                         x='Payload Mass (kg)', y='class', color="Booster Version Category")
        return fig
